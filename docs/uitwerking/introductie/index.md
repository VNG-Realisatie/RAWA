...
![Access Control List](./assets/ACL.png){:width="300px"}
...
![Role Based Access (RBAC)](./assets/RBAC.png){:width="300px"}
...
![Role Based Access (RBAC)](./assets2/RBAC.png){:width="300px"}
...
![Role Based Access (RBAC)](./assets/RBAC3.png){:width="300px"}
...
![Role Based Access (RBAC)](./assets/RBAC4.png){:width="300px"}
...
![Federatie](./assets/federatie.png){:width="300px"}
...
![DigiD](./assets/digid.png){:width="300px"}
...
![MijnOverheid](./assets/mijnoverheid.png){:width="300px"}
